...
let introTextBox= document.getElementById("intro-text");

introTextBox.addEventListener("mouseover", function(){
    hideDiv();
});
introTextBox.addEventListener("mouseout", function(){
    showDiv();
});

function showDiv() {
    document.getElementById("text-rational").style.display = "none";
    document.getElementById("text-heart").style.display = "block";
}

function hideDiv() {
    document.getElementById("text-rational").style.display = "block";
